...
def accel():
    ...
    x = [random.normalvariate(0, 5) for i in range(100)]
    y = [random.normalvariate(0, 5) for i in range(100)]
    z = [random.normalvariate(0, 5) for i in range(100)]
    Q = [-const.e for i in range(0, 100)]
...
def pos_and_vel():
    ...
    y = [random.normalvariate(0, 5) for i in range(100)]
    z = [random.normalvariate(0, 5) for i in range(100)]
    vx = [0 for i in range(0, 100)]
    vy = [0 for i in range(0, 100)]
    vz = [15 for i in range(0, 100)]
